...
export const WeChatProfile: React.FC<WeChatProfileProps> = ({
  ...
  return (
    <div className="absolute inset-0 z-10 flex flex-col overflow-hidden bg-[#EDEDED]">
      <div className="sticky top-0 z-20 shrink-0 bg-white px-2 pb-2 pt-12 flex items-center justify-between border-b border-gray-100">
        <button
          type="button"
