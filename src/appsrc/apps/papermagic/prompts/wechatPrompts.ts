...
* 如果要表达表情，只能使用普通 emoji 短码：[冷笑]、[流泪]、[大哭]、[大笑]、[发怒]、[酷]、[爱心]、[点赞]、[害羞]、[震惊]、[睡觉]、[眨眼]、[生病]、[不要]、[便便]、[庆祝]，界面会渲染成表情图片。严禁使用列表外短码，例如 [旺柴]、[奸笑]、[捂脸]、[微笑]。
...
- 如果要使用表情，只能使用普通 emoji 短码：[冷笑]、[流泪]、[大哭]、[大笑]、[发怒]、[酷]、[爱心]、[点赞]、[害羞]、[震惊]、[睡觉]、[眨眼]、[生病]、[不要]、[便便]、[庆祝]。不要使用 [旺柴]、[奸笑]、[捂脸]、[微笑] 等列表外短码。
- 表情只输出短码本身，优先用图片化表情接住情绪；严禁解释表情含义，严禁输出“表情含义”“≈”“气愤/无奈”这类说明文字。
...
- 如果图片或上下文更适合用表情接住，可以自然使用普通 emoji 短码：[冷笑]、[流泪]、[大哭]、[大笑]、[发怒]、[酷]、[爱心]、[点赞]、[害羞]、[震惊]、[睡觉]、[眨眼]、[生病]、[不要]、[便便]、[庆祝]。`;
